...
class DevicesHelper {
  ...
  Future<Database> _initDb() async {
    ...
    return await openDatabase(path, version: 1,
      ...
      db.execute(
          'CREATE TABLE $devicesTable ($idaparelhoColumn INTERGER PRIMARY KEY, $tipoColumn TEXT, $modeloColumn TEXT, $memoriaColumn TEXT, $corColumn TEXT, $custoColumn REAL, $numerodeserieColumn TEXT, $bateriaColumn INTERGER)');
    });
  }
